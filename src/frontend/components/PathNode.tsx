...
const toneStyles: Record<PathNodeData["tone"], string> = {
  start: "bg-slate-50 text-slate-700",
  interest: "bg-emerald-50 text-emerald-800",
  direction: "bg-blue-50 text-blue-800",
  skill: "bg-indigo-50 text-indigo-800",
  project: "bg-amber-50 text-amber-800",
  opportunity: "bg-yellow-50 text-yellow-800",
